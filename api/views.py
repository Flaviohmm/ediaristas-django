...
from .serializer import diarista_cidade_serializer
...
class DiaristasCidadeList(APIView):
  def get(self, request, format=None):
    ...
    serializer = diarista_cidade_serializer.DiaristaCidadeSerializer(diaristas, many=True, context={"request": request})
